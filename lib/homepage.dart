          ...
          child:  Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  Icon(Icons.thumb_up_alt_outlined , color: Colors.deepOrange,),
                  Icon(Icons.comment_bank_outlined,color: Colors.deepOrange,),
                  Icon(Icons.share_outlined,color: Colors.deepOrange,),
                ],
              ),
